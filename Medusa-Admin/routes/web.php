...
Route::group(['prefix'=>'admin','middleware'=>['auth']],function(){
    ...
    Route::group(['prefix'=>'brand'],function(){
        Route::get('/', [BrandController::class,'listBrand'])->middleware('can:list-brand');
        Route::post('/save-brand', [BrandController::class,'saveBrand'])->middleware('can:add-brand');
        Route::get('/edit-brand/{id}', [BrandController::class,'editBrand'])->middleware('can:edit-brand');
        Route::get('/update-brand/{id}', [BrandController::class,'updateBrand'])->middleware('can:edit-brand');
        Route::get('/delete-brand/{id}', [BrandController::class,'deleteBrand'])->middleware('can:delete-brand');
    });
    ...
    Route::group(['prefix'=>'product'],function(){
        ...
        // setting=====================================
        Route::get('/product-color', [ProductController::class,'listProductColor'])->middleware('can:list-product-color');
        Route::post('/save-product-color', [ProductController::class,'saveProductColor'])->middleware('can:add-product-color');
        Route::get('/delete-product-color/{id}', [ProductController::class,'deleteProductColor'])->middleware('can:delete-product-color');
        // Size
        Route::get('/product-size', [ProductController::class,'listProductSize'])->middleware('can:list-product-size');
        Route::post('/save-product-size', [ProductController::class,'saveProductSize'])->middleware('can:add-product-size');
        Route::get('/delete-product-size/{id}', [ProductController::class,'deleteProductSize'])->middleware('can:delete-product-size');

        // coupon
        Route::get('/coupon', [ProductController::class,'listCoupon'])->middleware('can:list-coupon');
        Route::post('/save-coupon', [ProductController::class,'saveCoupon'])->middleware('can:add-coupon');
        Route::get('/delete-coupon/{id}', [ProductController::class,'deleteCoupon'])->middleware('can:delete-coupon');
        Route::get('/edit-coupon/{id}', [ProductController::class,'editCoupon'])->middleware('can:edit-coupon');
        Route::get('/update-coupon/{id}', [ProductController::class,'updateCoupon'])->middleware('can:edit-coupon');

    });
    Route::group(['prefix'=>'order'],function(){
        Route::get('/', [OrderController::class,'listOrder'])->middleware('can:list-order');
        Route::get('/view-order/{id}', [OrderController::class,'viewOrder'])->middleware('can:edit-order');
        Route::post('/update-status/{id}', [OrderController::class,'updateOrderStatus'])->middleware('can:edit-order');
