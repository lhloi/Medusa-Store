                ...
                <div class="row">
                    ...
                    <div class="card col-12 ">
                        <div class="card-body col-12">
                            <form method="POST" action="{{ Url('admin/role/save-role/') }}" enctype="multipart/form-data">
                                @csrf
                                <div class="form-group">
                                    <label for="name">Tên Vai Trò</label>
                                    <input type="text" class="form-control @error('name') is-invalid @enderror"
                                        value="{{ old('name') }}" name="name" placeholder="Nhập tiêu đề role">
                                    @error('name')
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control tinymce_edit_init @error('display_name') is-invalid @enderror" name="display_name"
                                    ...
                                    <div class="card mb-3">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="card-body col-3">
                                                <h5 class="card-title ">
                                                    <label>
                                                        <input type="checkbox" name="permission_id[]" value="{{ $childrent->id }}" class="checkbox_childrent">
